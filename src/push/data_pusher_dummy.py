...
locations = ['Bucharest', 'Budapest', 'Riga', 'New York',
             'Washington', 'Paris', 'London', 'Berlin', 'Moscow', 'Tbilisi']
roles = ['Implementing', 'Executing', 'Reporting', 'Donor', 'Recipient']
sources = ['Yahoo', 'Google', 'Bing', 'Local', 'Other']
names = ['World', 'Nations', 'Union', 'Bank', 'International',
         'European', 'American', 'Inter', 'African', 'Nations']
...
def push_to_solr(elem_list):
    ...
    response = requests.post(
        solr_url, jsonEl, headers={'content-type': 'application/json'})
